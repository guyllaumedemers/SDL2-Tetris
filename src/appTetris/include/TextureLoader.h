...
public:
	...
	static std::unordered_map<std::string, std::unique_ptr<SDL_Texture, FreeSDLTexture>> GetTextures(std::function<SDL_Texture* (std::string, SDL_Renderer*)> FuncPtr, SDL_Renderer* Renderer);
};
#endif